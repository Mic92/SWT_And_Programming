...
public class TestFilledBibliothek {
	...
	public void testBestandNachAutorAuflisten() {
		Map test = bibo.bestandNachAutorAuflisten();
		
		assertTrue("The method bestandNachAutorAuflisten return a map with all authors mentioned in the libraries books!",test.containsKey("0"));
		assertTrue("The method bestandNachAutorAuflisten return a map with all authors mentioned in the libraries books!",test.containsKey("1"));
		assertTrue("The method bestandNachAutorAuflisten return a map with all authors mentioned in the libraries books!",test.containsKey("2"));
		assertTrue("The method bestandNachAutorAuflisten return a map with all authors mentioned in the libraries books!",test.containsKey("3"));
		
		assertTrue("The map returned by bestandNachAutorAuflisten should contain a set for each author listing the books he has written!",((Set)test.get("2")).containsAll(Arrays.asList(new Buch[]{b3,b5})));
	}
